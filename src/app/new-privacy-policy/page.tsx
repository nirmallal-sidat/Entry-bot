      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="relative p-12 bg-zinc-50 border-2 border-black rounded-sm shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          ...
          <div className="space-y-8 text-black font-medium leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                <span className="w-8 h-8 bg-black text-white flex items-center justify-center text-sm rounded-full">03</span>
                Security Measures
              </h2>
              <p className="border-l-4 border-black ml-4 py-2 pl-7 bg-white">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                <span className="w-8 h-8 bg-black text-white flex items-center justify-center text-sm rounded-full">04</span>
                Your Rights
              </h2>
              <p className="pl-11">
